...
How do we know it's retardation effects? Well, the quasistatic resonance energies are wrong.

\begin{figure}
\begin{centering}
\includegraphics{qs_limit.pdf}
\caption{quasistatic resonance energies}
\label{qs_limit}
\end{centering}
\end{figure}

Just to be sure, let's look closer and make sure they're actually splitting and this isn't an artifact of our eyes.

\begin{figure}
\begin{centering}
\includegraphics{eig_diff_scale.pdf}
\caption{difference from average with scaling}
\label{diff_scale}
\end{centering}
\end{figure}

But wait, I thought the quasistatic approxiamtion was good for MNPs that were half the wavelength of light! Nah.

\begin{figure}
\begin{centering}
\includegraphics{length_comparison_scale.pdf}
\caption{comparing to optical wavelength}
\label{scale_wavelength_comp}
\end{centering}
\end{figure}

Is this effect even real? Shouldn't the eigenvalues cross forever? They do!

\begin{figure}
\begin{centering}
\includegraphics{bigger_particles.pdf}
\caption{bigger particles}
\label{bigp}
\end{centering}
\end{figure}
...
I can barely see those wiggles! Are they even real?

\begin{figure}
\begin{centering}
\includegraphics{diff_avg_space.pdf}
\caption{spacing exponential relevance}
\label{diff_avg_space}
\end{centering}
\end{figure}

Okay, okay, but are these things big enough to be considered fully retarded?

\begin{figure}
\begin{centering}
\includegraphics{length_comp_sapcing.pdf}
\caption{wavelength comparison for spacing}
\label{length_space}
\end{centering}
\end{figure}
...
\caption{index of refraction as a function of energy and size}
\label{n_plot}
\end{centering}
\end{figure}
